...
const EgitGrayIcon = () => (
	<Svg width={14} height={15} fill="none">
		...
		<Path
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			d="m5.15 6.87 4.359-4.359a1.391 1.391 0 0 1 1.966 0l.71.71a1.39 1.39 0 0 1 0 1.967l-4.38 4.38c-.238.237-.56.37-.896.37H4.724l.055-2.204c.008-.324.14-.634.37-.863Z"
			clipRule="evenodd"
		/>
		<Path
			stroke="#303336"
